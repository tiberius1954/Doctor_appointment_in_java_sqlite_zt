...
//		Ingredient ingredient;
		...
		if ("doctors".equals(gn)) {
			for (int i = 0; i < comboBox.getItemCount(); i++) {
				doctor = (Doctor) comboBox.getItemAt(i);
				if (doctor.getDid() == value) {
...
//				}}}
	...
	//	textField.setBorder(borderf);
		textField.setBorder(BorderFactory.createMatteBorder(1, 1, 2, 2, Color.DARK_GRAY));
	...
	public JTextArea cTextarea() {
		...
		txarea.setBorder(BorderFactory.createMatteBorder(1, 1, 2, 2, Color.DARK_GRAY));
	...
	public void iconhere(JFrame that) {
		ImageIcon ImageIcon = new ImageIcon(ClassLoader.getSystemResource("images/appointment.png"));
